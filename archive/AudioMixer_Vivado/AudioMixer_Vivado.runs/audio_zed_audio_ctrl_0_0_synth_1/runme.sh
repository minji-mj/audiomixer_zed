...
HD_PWD='C:/Users/minji/Desktop/AudioMixer_Project/AudioMixer_Vivado/AudioMixer_Vivado/AudioMixer_Vivado.runs/audio_zed_audio_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_zed_audio_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_zed_audio_ctrl_0_0.tcl
